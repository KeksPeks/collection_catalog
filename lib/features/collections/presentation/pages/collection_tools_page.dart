    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(ok ? 'Уведомления разрешены.' : 'Разрешение не выдано.')),
        );
      }
    } catch (error) {
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 8),
                Expanded(child: _Metric('Расходы', '€${cost.toStringAsFixed(2)}', Icons.euro_outlined)),
              ],
            ),
            const SizedBox(height: 12),
            ...
            Card(
              child: ExpansionTile(
                ...
                children: _history.isEmpty
                    ...
                    : _history.take(30).map((entry) => ListTile(title: Text(entry.title), subtitle: Text('${entry.details}\n${entry.timestamp}'))).toList(),
              ),
            ),
            Card(
              child: ExpansionTile(
