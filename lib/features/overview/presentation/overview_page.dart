...
/// Локальный обзор коллекционера. Статистика и достижения хранятся на устройстве.
...
class _OverviewPageState extends ConsumerState<OverviewPage> {
  static const achievements = <Achievement>[
    ...
    Achievement(
      id: 'ten_items',
      title: 'Первые шаги',
      description: 'Добавьте 10 отслеживаемых предметов',
      icon: '🧩',
      target: 10,
      rewardXp: 50,
    ),
    Achievement(
      id: 'hundred_items',
      title: 'Собиратель',
      description: 'Добавьте 100 отслеживаемых предметов',
      icon: '🗃️',
      target: 100,
      rewardXp: 150,
    ),
    ...
    Achievement(
      ...
      title: 'Архивариус',
      description: 'Добавьте 500 отслеживаемых предметов',
      icon: '🏛️',
      target: 500,
      rewardXp: 500,
    ),
    Achievement(
      ...
      description: 'Добавьте 1000 отслеживаемых предметов',
      icon: '👑',
      target: 1000,
      rewardXp: 1000,
    ),
  ...
  int _valueFor(String id, int collections, int items) {
    if (id == 'first_collection' || id == 'five_collections') {
      return collections;
    }
    return items;
  }
    ...
    return Scaffold(
      ...
      body: asyncCollections.when(
        ...
        data: (collections) => FutureBuilder<_Stats>(
          future: _loadStats(
            collections.where((item) => item.templateId != null).length,
          ),
          builder: (context, snapshot) {
            ...
            final stats =
                snapshot.data ?? const _Stats(0, 0, 0, <String>{});
            ...
            return RefreshIndicator(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  const Text(
                    'Статистика и достижения рассчитываются локально на устройстве и не требуют сервера.',
          ...
          children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Уровень $level · ${stats.xp} XP'),
                    ],
                  ),
                ),
              ],
            ...
            Wrap(
              ...
              children: [
                ...
                Text('${stats.items} отслеживаемых предметов'),
...
class _AchievementTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final progress =
        (value / achievement.target).clamp(0.0, 1.0).toDouble();
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Text(
              unlocked
                  ? 'Получено · +${achievement.rewardXp} XP'
                  : '$value / ${achievement.target} · +${achievement.rewardXp} XP',
            ),
          ],
        ),
        trailing: unlocked
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Не удалось открыть локальный обзор',
              textAlign: TextAlign.center,
            ),
            const SizedBox(height: 8),
