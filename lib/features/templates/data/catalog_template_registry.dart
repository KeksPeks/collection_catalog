...
class CatalogTemplateRegistry {
  static List<Template> get all => [
        _template('constructors', 'Конструкторы', 'Универсальный каталог конструкторов.', [
          _field('brand', 'Производитель', FieldType.text),
          _field('series', 'Серия', FieldType.text),
          _field('model', 'Модель', FieldType.text),
          _field('year', 'Год', FieldType.integer),
          _field('pieces', 'Количество деталей', FieldType.integer),
          _field('theme', 'Тематика', FieldType.text),
        ...
        _template('coins', 'Монеты', 'Нумизматический каталог', [
          ...
          _field('year', 'Год', FieldType.integer), _field('mint', 'Монетный двор', FieldType.text),
          _field('metal', 'Металл', FieldType.text), _field('variety', 'Разновидность', FieldType.text),
  ...
  static Template _template(String id, String name, String description, List<FieldDefinition> fields) =>
      Template(id: id, name: name, description: description, fields: fields);

  static FieldDefinition _field(String id, String label, FieldType type) =>
      FieldDefinition(id: id, collectionId: '', label: label, type: type);
}
