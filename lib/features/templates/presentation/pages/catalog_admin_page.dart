        ...
        children: [
          Card(
            child: ListTile(
              ...
              subtitle: const Text('Прогресс, статистика, поиск, история, сканер и уведомления.'),
              trailing: const Icon(Icons.chevron_right),
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const CollectionToolsPage()),
              ),
            ),
          ),
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      adminBuild
                          ? 'Административная сборка активна. Публикация структуры должна выполняться централизованно.'
                          : 'Структура каталогов централизована. Пользователь только скачивает каталог, меняет личное состояние и отправляет предложения через обратную связь.',
                    ),
                  ),
                ],
              ),
