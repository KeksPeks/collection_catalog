...
class BuiltInTemplateRegistry {
  static final List<Template> templates = [
    ...
    Template(id: 'figurines', name: 'Фигурки', description: 'Персонаж, серия, производитель, масштаб, материал, год и состояние.', fields: [_f('name', 'Название', FieldType.text), _f('series', 'Серия', FieldType.text), _f('character', 'Персонаж', FieldType.text), _f('manufacturer', 'Производитель', FieldType.text), _f('scale', 'Масштаб', FieldType.text), _f('material', 'Материал', FieldType.text), _f('year', 'Год', FieldType.integer), _f('condition', 'Состояние', FieldType.text)]),
  ];
