...
class CatalogRegistry {
  ...
  static CatalogDefinition _coins(List<Template> templates) {
    ...
    return CatalogDefinition(id:'coins',name:'Нумизматика',description:'Каталог нумизматики: монеты по странам, типам чеканки и годам.',templateId:template.id,template:template,primaryField:'country',totalItems:8,version:3,changes:const ['Название синхронизировано с направлением «Нумизматика».','Страны показываются сразу при входе в каталог; убрана лишняя группа «Страны».'],entries:const [
